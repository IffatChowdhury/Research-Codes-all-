...
def main():
	...
	fileHandle = open('output_projection_red.txt', 'r')
	win = GraphWin('Test', 1000, 1000) # give title and dimensions
	win.setCoords(-290, 1900, 2000, 4500);
	count = 0
	...
	while count != length:
		...
		for x in range(2, noOfMovements):
			...
			line = Line(Point(a, b), Point(c, d)) #650
			line.setWidth(4)
			line.setFill("red")
			line.draw(win)
			#print a
	...
	fileHandle2 = open('output_star_blue.txt', 'r')
	...
	while count2 != length:
		...
		for x in range(2, noOfMovements):
			...
			line2 = Line(Point(a, b + 1500), Point(c, d + 1500))
			line2.setWidth(2)
			line2.setFill("blue")
			line2.draw(win)
			#print a
	...
	fileHandle2 = open('output_projection_blue.txt', 'r')
	#win2 = GraphWin('Test', 800, 800) # give title and dimensions
	#win2.setCoords(0,0,2000,2000);
	count2 = 0
  	linesList2 = fileHandle2.readlines()
