...
int main(){
	...
	x1_min = 0; x1_max = 0; x2_min = 26; x2_max = 33; y1 = 15; z1 = 30; y2 = 32; z2 = 47;
	...
	//srand(time(NULL));
	//int numOfYandZ1 = rand() % 100 + 1;
	//int numOfYandZ2 = rand() % 100 + 1;
	
	//int numOfYandZ = 17;
	//cout << "random number1 " << numOfYandZ1 << endl; 
	//cout << "random number2 " << numOfYandZ2 << endl; 
	int y_min, z_min;
	y_min = 15;
	z_min = 30;
	
	//for (int u2 = y_min; u2 < (y_min + numOfYandZ1); u2++){
	//for (int u3 = z_min; u3 < (z_min + numOfYandZ1); u3++){
	  
	  //y1 = u2; y2 = y1 + numOfYandZ1;
	  //z1 = u3; z2 = z1 + numOfYandZ1;
	...
	//cout << "y1 :" << y1 << " " << "z1 :" << z1 << " " << "y2 :" << y2 << " " << "z2 :" << z2 << endl;
			...
			if (f == -1){ // xz planes are handled
				...
				if (check == -1){
					...
					/*if (mat1 == 0){
						...
						cout << "xz -> xy on fold :" << folds[fold_iterate] << endl;
						cout << "x1 :" << p.coord[XCoord] << " y1 :" << p.coord[YCoord] << " " << " z1 :" << p.coord[ZCoord] << " " << " x2 :" << q.coord[XCoord] << " y2 :" << q.coord[YCoord] << " " << " z2 :" << q.coord[ZCoord] << endl;
						mat1++;
					}*/
			...
			if (f == -1){ // xy planes are handled
				...
				if (check == -1){
					...
					/*if (mat2 == 0){
						...
						cout << "xy -> xz on fold :" << folds[fold_iterate] << endl;
						cout << "x1 :" << p.coord[XCoord] << " y1 :" << p.coord[YCoord] << " " << " z1 :" << p.coord[ZCoord] << " " << " x2 :" << q.coord[XCoord] << " y2 :" << q.coord[YCoord] << " " << " z2 :" << q.coord[ZCoord] << endl;
						mat2++;
					}*/
